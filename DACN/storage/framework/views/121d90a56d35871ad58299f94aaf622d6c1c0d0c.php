...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Phòng khám Sản Phụ Khoa'); ?></title>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/patient-design-system.css')); ?>">
...
<body>
    ...
    <aside class="sidebar" id="sidebar">
        <div class="p-4">
                ...
                <div class="d-flex align-items-center gap-3">
                    <div style="width: 48px; height: 48px; background: white; border-radius: 50%; overflow: hidden;">
                        <?php if(auth()->user()->avatar): ?>
                            <img src="<?php echo e(Storage::url(auth()->user()->avatar)); ?>" alt="Avatar" style="width: 100%; height: 100%; object-fit: cover;">
                        <?php else: ?>
                    ...
                    <div class="flex-grow-1">
                        <p class="text-white mb-0" style="font-weight: 600; font-size: 0.875rem;"><?php echo e(auth()->user()->name); ?></p>
            ...
            <nav>
                <a href="<?php echo e(route('patient.dashboard.health')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.dashboard.health') ? 'active' : ''); ?>">
                    <i class="fas fa-th-large" style="width: 20px;"></i>
                    <span>Tổng quan</span>
                </a>

                <a href="<?php echo e(route('lichhen.my')); ?>" class="sidebar-link <?php echo e(request()->routeIs('lichhen.my') ? 'active' : ''); ?>">
                    ...
                    <?php if($pendingCount > 0): ?>
                        <span class="ms-auto" style="background: #ef4444; color: white; font-size: 0.75rem; padding: 0.25rem 0.5rem; border-radius: 9999px;"><?php echo e($pendingCount); ?></span>
                    <?php endif; ?>
                </a>

                <a href="<?php echo e(route('patient.benhan.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.benhan.*') ? 'active' : ''); ?>">
                    <i class="fas fa-file-medical" style="width: 20px;"></i>
                    <span>Hồ sơ bệnh án</span>
                </a>

                <a href="<?php echo e(route('patient.donthuoc.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.donthuoc.*') ? 'active' : ''); ?>">
                    <i class="fas fa-prescription" style="width: 20px;"></i>
                    <span>Đơn thuốc</span>
                </a>

                <a href="<?php echo e(route('patient.xetnghiem.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.xetnghiem.*') ? 'active' : ''); ?>">
                    <i class="fas fa-flask" style="width: 20px;"></i>
                    <span>Kết quả xét nghiệm</span>
                </a>

                <a href="<?php echo e(route('patient.sieuam.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.sieuam.*') ? 'active' : ''); ?>">
                    <i class="fas fa-heartbeat" style="width: 20px;"></i>
                    <span>Kết quả siêu âm</span>
                </a>

                <a href="<?php echo e(route('patient.thuthuat.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.thuthuat.*') ? 'active' : ''); ?>">
                    <i class="fas fa-procedures" style="width: 20px;"></i>
                    <span>Kết quả thủ thuật</span>
                </a>

                <a href="<?php echo e(route('patient.hoadon.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.hoadon.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('patient.shop.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.shop.index') ? 'active' : ''); ?>">
                    <i class="fas fa-shopping-cart" style="width: 20px;"></i>
                    <span>Cửa hàng thuốc</span>
                </a>

                <a href="<?php echo e(route('patient.shop.orders')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.shop.orders') ? 'active' : ''); ?>">
                    <i class="fas fa-box" style="width: 20px;"></i>
                    <span>Đơn hàng của tôi</span>
                </a>

                <a href="<?php echo e(route('patient.coupons.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.coupons.*') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('public.bacsi.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('public.bacsi.*') ? 'active' : ''); ?>">
                    <i class="fas fa-user-md" style="width: 20px;"></i>
                    <span>Danh sách bác sĩ</span>
                </a>

                <a href="<?php echo e(route('patient.chat.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.chat.*') ? 'active' : ''); ?>">
                    <i class="fas fa-comments" style="width: 20px;"></i>
                    <span>Tư vấn online</span>
                </a>

                <a href="<?php echo e(route('patient.danhgia.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.danhgia.*') ? 'active' : ''); ?>">
                    <i class="fas fa-star" style="width: 20px;"></i>
                    <span>Đánh giá của tôi</span>
                </a>

                <a href="<?php echo e(route('patient.lich-su-kham')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.lich-su-kham') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('patient.family.index')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.family.*') ? 'active' : ''); ?>">
                    <i class="fas fa-users" style="width: 20px;"></i>
                    <span>Thành viên gia đình</span>
                </a>

                <a href="<?php echo e(route('patient.notifications')); ?>" class="sidebar-link <?php echo e(request()->routeIs('patient.notifications') ? 'active' : ''); ?>">
                    <i class="fas fa-bell" style="width: 20px;"></i>
                    <span>Thông báo</span>
                    <?php if(auth()->user()->unreadNotifications->count() > 0): ?>
                        <span class="ms-auto" style="background: #ef4444; color: white; font-size: 0.75rem; padding: 0.25rem 0.5rem; border-radius: 9999px;"><?php echo e(auth()->user()->unreadNotifications->count()); ?></span>
                    <?php endif; ?>
                </a>
    ...
    <div class="main-content">
        ...
        <div class="top-nav d-flex align-items-center justify-content-between flex-wrap">
            <div class="d-flex align-items-center gap-4">
                ...
                <div>
                    <h2 class="mb-0" style="font-size: 1.5rem; font-weight: 700; color: #1f2937;"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h2>
                    <p class="mb-0" style="font-size: 0.875rem; color: #6b7280;"><?php echo $__env->yieldContent('page-subtitle', 'Chào mừng bạn trở lại'); ?></p>
                </div>
            </div>
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <div class="position-relative">
                    <a href="<?php echo e(route('patient.notifications')); ?>" class="btn p-2" style="color: #6b7280;">
        ...
        <footer class="mt-5 py-4 border-top">
            <div class="text-center text-muted">
                <p class="mb-1">&copy; <?php echo e(date('Y')); ?> HealthCare Clinic. All rights reserved.</p>
...
<?php /**PATH F:\WORKING\DACN\DACN\resources\views/layouts/patient-modern.blade.php ENDPATH**/ ?>