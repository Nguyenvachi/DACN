                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0 mt-1" style="color: #f59e0b;"><?php echo e($stats['waiting']); ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0 mt-1" style="color: #10b981;"><?php echo e($stats['in_progress']); ?></h3>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0 mt-1" style="color: #3b82f6;"><?php echo e($stats['confirmed_today']); ?></h3>
                        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0 mt-1" style="color: #8b5cf6;">
                                <?php echo e($stats['avg_wait_time'] ?? 0); ?> phút
                            </h3>
                        </div>
    ...
    <div class="vc-card mb-4">
        <div class="card-header bg-white border-0 pt-3 pb-0">
            <h5 class="fw-bold mb-0">
                ...
                Bệnh nhân đang chờ (<?php echo e($waitingQueue->count()); ?>)
            </h5>
        </div>
        <div class="card-body">
            <?php if($waitingQueue->isEmpty()): ?>
            ...
            <?php else: ?>
                <div class="row g-3">
                    <?php $__currentLoopData = $waitingQueue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-start mb-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <div class="fw-bold"><?php echo e($appt->user->name); ?></div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="fw-semibold" style="color: #f59e0b;">
                                        ...
                                        ?>
                                        <?php echo e($waitTime); ?> phút
                                    </div>
                                </div>

                                <form action="<?php echo e(route('doctor.queue.start', $appt->id)); ?>" method="POST" class="start-exam-form">
                                    <?php echo csrf_field(); ?>
    ...
    <div class="vc-card mb-4">
        <div class="card-header bg-white border-0 pt-3 pb-0">
            <h5 class="fw-bold mb-0">
                ...
                Đang khám (<?php echo e($inProgressQueue->count()); ?>)
            </h5>
        </div>
        <div class="card-body">
            <?php if($inProgressQueue->isEmpty()): ?>
                <div class="text-center py-4">
            ...
            <?php else: ?>
                <div class="row g-3">
                    <?php $__currentLoopData = $inProgressQueue; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-3">
                                        <div class="fw-bold text-dark mb-1" style="font-size: 1.1rem;">
                                            <?php echo e($appt->user->name); ?>

                                        </div>
                                        <div class="d-flex flex-column gap-1">
                                            <small class="text-muted">
                                                <i class="fas fa-id-card me-1"></i>
                                                Mã BN: #<?php echo e($appt->user->id); ?>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <?php if($appt->bacSi && $appt->bacSi->phong): ?>
                                        <div class="mt-2">
                                            <small class="text-muted d-block">Phòng khám</small>
                                            <span class="fw-semibold text-primary">
                                                <i class="fas fa-door-open me-1"></i>
                                                <?php echo e($appt->bacSi->phong->ten_phong); ?>
                                        ...
                                        <div class="d-flex flex-column gap-2">
                                            <div>
                                                ...
                                                <div class="fw-semibold text-success">
                                                    ...
                                                    <?php echo e($startTime ? \Carbon\Carbon::parse($startTime)->format('H:i') : 'N/A'); ?>

                                                </div>
                                            </div>
                                            <div>
                                                <small class="text-muted d-block">Thời gian khám</small>
                                                <div class="fw-bold <?php echo e($duration > 30 ? 'text-warning' : 'text-success'); ?>">
                                                    <i class="fas fa-stopwatch me-1"></i>
                                                    <?php echo e($duration); ?> phút
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="progress mb-2" style="height: 8px;">
                                            ...
                                            <div class="progress-bar" role="progressbar" 
                                                 style="width: <?php echo e($progress); ?>%; background: <?php echo e($progressColor); ?>;"
                                                 aria-valuenow="<?php echo e($progress); ?>" aria-valuemin="0" aria-valuemax="100">
                                            </div>
                                        </div>
                                        <small class="text-muted">
                                            <?php echo e(min(100, round($progress))); ?>% / Dự kiến: <?php echo e($expectedDuration); ?>p
                                        </small>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="d-flex flex-column gap-2">
                                            ...
                                            <?php else: ?>
                                                <form action="<?php echo e(route('doctor.queue.start', $appt->id)); ?>" method="POST">
                                                    <?php echo csrf_field(); ?>
    ...
    <div class="vc-card">
        <div class="card-header bg-white border-0 pt-3 pb-0">
            <h5 class="fw-bold mb-0">
                ...
                Đã xác nhận hôm nay (<?php echo e($confirmedToday->count()); ?>)
            </h5>
        </div>
        <div class="card-body p-0">
            <?php if($confirmedToday->isEmpty()): ?>
                <div class="text-center py-4">
            ...
            <?php else: ?>
                <div class="table-responsive">
                    <table class="appointment-today-table">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $confirmedToday; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="me-2" style="width: 35px; height: 35px; border-radius: 50%; background: linear-gradient(135deg, #3b82f6, #2563eb); color: white; display: flex; align-items: center; justify-content: center; font-weight: 700; font-size: 0.9rem;">
                                            <?php echo e(strtoupper(substr($appt->user->name, 0, 1))); ?>

                                        </div>
                                        <div>
                                            <div class="fw-semibold"><?php echo e($appt->user->name); ?></div>
                                            <small class="text-muted"><?php echo e($appt->user->email); ?></small>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td>
                                    <span class="status-badge status-<?php echo e($appt->trang_thai); ?>">
                                        <?php echo e(ucfirst($appt->trang_thai)); ?>

                                    </span>
                                </td>
                                <td class="text-center">
                                    <?php if($appt->trang_thai === \App\Models\LichHen::STATUS_CONFIRMED_VN): ?>
                                        <form action="<?php echo e(route('doctor.queue.checkin', $appt->id)); ?>"
                                              method="POST"
                                    ...
                                    <?php elseif($appt->trang_thai === \App\Models\LichHen::STATUS_CHECKED_IN_VN): ?>
                                        <span class="badge bg-warning">Đang chờ</span>
                                    <?php elseif($appt->trang_thai === \App\Models\LichHen::STATUS_IN_PROGRESS_VN): ?>
                                        <?php if($appt->benhAn): ?>
                                            <a href="<?php echo e(route('doctor.benhan.edit', $appt->benhAn->id)); ?>"
...
<?php echo $__env->make('layouts.doctor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\WORKING\DACN\DACN\resources\views/doctor/queue/index.blade.php ENDPATH**/ ?>