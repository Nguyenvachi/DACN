...
<body>
    ...
    <nav class="vc-navbar navbar navbar-expand-lg sticky-top">
        <div class="container">
            ...
            <a class="navbar-brand d-flex align-items-center gap-2" href="<?php echo e(route('homepage')); ?>">
            ...
            <div class="collapse navbar-collapse" id="vcNavbar">
                <ul class="navbar-nav ms-auto align-items-center">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo e(route('public.blog.index')); ?>">Tin Tức</a></li>

                    <?php if(auth()->guard()->check()): ?>
                        
                        <li class="nav-item">
                            <a class="nav-link d-flex align-items-center" href="<?php echo e(route('home')); ?>">
                        ...
                        <?php if(auth()->user()->role === 'patient'): ?>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('patient.shop.index')); ?>">Cửa Hàng</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('patient.shop.cart')); ?>">Giỏ Hàng</a>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('patient.shop.orders')); ?>">Đơn Hàng</a>
                            </li>
                        <?php endif; ?>
            ...
            <div class="row align-items-center py-5">
                ...
                <div class="col-lg-6 vc-hero-content">
                    ...
                    <div class="d-flex flex-wrap gap-3 mb-4">
                        <a href="<?php echo e(route('public.bacsi.index')); ?>" class="btn vc-btn-white-lg">
                        ...
                        <?php if(Route::has('public.lichhen.calendar')): ?>
                            <a href="<?php echo e(route('public.lichhen.calendar')); ?>" class="btn vc-btn-outline-lg">
                    ...
                    <div class="vc-hero-stats d-flex gap-4 flex-wrap">
                        ...
                        <div class="vc-stat">
                            <span class="vc-stat-number" data-target="<?php echo e($doctorCount); ?>">0+</span>
                            <span class="vc-stat-label">Bác Sĩ Chuyên Khoa</span>
                        </div>

                        <div class="vc-stat">
                            <span class="vc-stat-number" data-target="<?php echo e($patientCount); ?>">0+</span>
                            <span class="vc-stat-label">Bệnh Nhân Tin Tưởng</span>
                        </div>

                        <div class="vc-stat">
                            <span class="vc-stat-number" data-target="<?php echo e($appointmentCount); ?>">0+</span>
        ...
        <div class="container">
            ...
            <div class="row mt-4">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <a href="<?php echo e(route('public.bacsi.index')); ?>" class="text-decoration-none">
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <a href="<?php echo e(route('public.dichvu.index')); ?>" class="text-decoration-none">
                        <div class="vc-card feature-card h-100 text-center p-4">
                            <div class="vc-feature-icon mb-3">
                                <i class="fas fa-heartbeat"></i>
                            </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <a href="<?php echo e(auth()->check() && auth()->user()->role === 'patient' ? route('patient.shop.index') : route('login')); ?>"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-7">
                    <div class="vc-card p-4 shadow-lg" style="border-radius: 20px;">
                        <form action="<?php echo e(route('lichhen.create', ['bacSi' => 'select'])); ?>" method="GET" id="quickBookingForm">
                            <div class="row g-3">
                                    ...
                                    <select class="form-select" name="chuyen_khoa" id="quickChuyenKhoa" required>
                                        ...
                                        <?php
                                            $chuyenKhoas = \App\Models\ChuyenKhoa::withCount('bacSis')
                                                ...
                                                ->get();
                                        ?>
                                        <?php $__currentLoopData = $chuyenKhoas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ck): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($ck->id); ?>"><?php echo e($ck->ten); ?></option>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="tel" class="form-control" name="so_dien_thoai"
                                           ...
                                           value="<?php echo e(auth()->check() ? auth()->user()->so_dien_thoai : ''); ?>">
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <?php else: ?>
                                        <a href="<?php echo e(route('login')); ?>" class="btn vc-btn-primary w-100 py-3">
    ...
    <section id="doctors" class="vc-doctors py-5 bg-white">
        <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="vc-card doctor-card h-100">
                            ...
                            <div class="doctor-image">
                                <?php if($doctor->anh_dai_dien): ?>
                                    <img src="<?php echo e(asset('storage/' . $doctor->anh_dai_dien)); ?>"
                                        alt="<?php echo e($doctor->ho_ten); ?>" class="w-100 h-100" loading="lazy"
                            ...
                            <div class="p-4">
                                <h5 class="fw-bold"><?php echo e($doctor->ho_ten); ?></h5>

                                <div class="text-success small mb-2">
                                    <?php if($doctor->chuyenKhoas->count()): ?>
                                        <?php echo e($doctor->chuyenKhoas->pluck('ten_chuyen_khoa')->join(', ')); ?>
                                ...
                                <p class="text-muted small mb-3">
                                    <?php echo e(Str::limit($doctor->mo_ta ?? 'Bác sĩ luôn tận tâm với bệnh nhân.', 110)); ?>
                                ...
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="<?php echo e(route('lichhen.create', $doctor->id)); ?>" class="btn vc-btn-primary">
                                        <i class="fas fa-calendar-plus me-2"></i>Đặt Lịch Khám
                                    </a>

                                    
                                    <a href="<?php echo e(route('public.bacsi.index') . '?id=' . $doctor->id); ?>"
                                        class="btn btn-outline-primary">
                                        <i class="fas fa-user-circle me-2"></i>Hồ Sơ Bác Sĩ
                                    </a>

                                    
                                    <?php if(Route::has('public.bacsi.schedule')): ?>
                                        <a href="<?php echo e(route('public.bacsi.schedule', $doctor->id)); ?>"
                                    ...
                                    <?php if(auth()->guard()->check()): ?>
                                        <?php if(auth()->user()->role === 'patient'): ?>
                                            <a href="<?php echo e(route('patient.chat.create', $doctor->id)); ?>"
            ...
            <div class="text-center mt-3">
                <a href="<?php echo e(route('public.bacsi.index')); ?>" class="btn vc-btn-outline-lg">
    ...
    <section id="services" class="vc-services py-5" style="background:#f9fafb;">
        <div class="container">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $specialty): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="vc-card service-card h-100 p-4">
                            ...
                            <h5 class="fw-bold"><?php echo e($specialty->ten_chuyen_khoa); ?></h5>

                            
                            <p class="text-muted small">
                                <?php echo e(Str::limit($specialty->mo_ta ?? 'Chuyên khoa điều trị chất lượng cao.', 120)); ?>
                            ...
                            <small class="text-muted d-block">
                                ...
                                <?php echo e($specialty->bac_sis_count); ?> bác sĩ
                            </small>

                            
                            <div class="mt-3 d-grid gap-2">
                                
                                <a href="<?php echo e(route('public.bacsi.index') . '?chuyen_khoa=' . urlencode($specialty->ten_chuyen_khoa)); ?>"
                                    class="btn btn-outline-primary btn-sm">
                                    <i class="fas fa-search me-1"></i>Xem bác sĩ
                                </a>

                                
                                <a href="<?php echo e(route('public.dichvu.index')); ?>"
            ...
            <div class="text-center mt-4">
                <a href="<?php echo e(route('public.dichvu.index')); ?>" class="btn vc-btn-primary">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-4 col-md-6">
                        <div class="vc-card h-100 p-4">
                            ...
                            <div class="mb-3">
                                <?php for($i = 1; $i <= 5; $i++): ?>
                                    <i class="fas fa-star" style="color: <?php echo e($i <= $review->rating ? '#fbbf24' : '#e5e7eb'); ?>;"></i>
                                <?php endfor; ?>
                            </div>

                            
                            <p class="text-muted mb-3" style="font-size: 0.95rem; line-height: 1.6;">
                                "<?php echo e(Str::limit($review->noi_dung, 150)); ?>"
                            </p>
                            ...
                            <div class="d-flex align-items-center gap-3 pt-3 border-top">
                                <div class="rounded-circle bg-success d-flex align-items-center justify-content-center"
                                    ...
                                    <?php if($review->user && $review->user->anh_dai_dien): ?>
                                        <img src="<?php echo e(asset('storage/' . $review->user->anh_dai_dien)); ?>"
                                ...
                                <div>
                                    <div class="fw-bold"><?php echo e($review->user->name ?? 'Bệnh nhân'); ?></div>
                                    <small class="text-muted">
                                        Khám với <?php echo e($review->bacSi->ho_ten ?? 'Bác sĩ'); ?>
    ...
    <section class="vc-blog-highlights py-5" style="background: #f9fafb;">
        <div class="container">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $latestPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-4 col-md-6">
                        <article class="vc-card h-100" style="overflow: hidden;">
                            ...
                            <div class="p-4">
                                <?php if($post->danhMuc): ?>
                                    <span class="badge bg-success mb-2"><?php echo e($post->danhMuc->name); ?></span>
                                <?php endif; ?>
                                ...
                                <div class="d-flex justify-content-between align-items-center pt-3 border-top">
                                    <small class="text-muted">
                                        ...
                                        <?php echo e(optional($post->published_at ?? $post->created_at)->format('d/m/Y')); ?>
            ...
            <?php if($latestPosts->count() > 0): ?>
                <div class="text-center mt-4">
                    <a href="<?php echo e(route('public.blog.index')); ?>" class="btn vc-btn-primary">
                        ...
                        <div class="accordion-item border-0 mb-3 vc-card">
                            ...
                            <div id="faq2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                                <div class="accordion-body">
                                    ...
                                    tại mục <a href="<?php echo e(route('public.dichvu.index')); ?>">Dịch vụ</a>.
    ...
    <section class="vc-cta py-5">
        <div class="container text-center">
            ...
            <div class="d-flex justify-content-center gap-3 flex-wrap mt-4">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <?php if(auth()->user()->role === 'patient'): ?>
                        <a href="<?php echo e(route('patient.chat.index')); ?>" class="btn vc-btn-primary">
                            <i class="fas fa-comments me-2"></i>Tư Vấn Online
                        </a>
                    <?php else: ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.auth-modal','data' => []] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    ...
    <footer class="vc-footer">
        <div class="container py-5">
            ...
            <div class="row gy-4">
                ...
                <div class="col-lg-2 col-md-6 footer-column">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li><a href="<?php echo e(route('public.blog.index')); ?>">Tin Tức</a></li>
                ...
                <div class="col-lg-3 col-md-6 footer-column">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li>
                            <a href="<?php echo e(route('public.bacsi.index')); ?>">Đặt Lịch Khám</a>
                        </li>

                        <li>
                            <a href="<?php echo e(route('public.dichvu.index')); ?>">Danh Sách Dịch Vụ</a>
                        </li>
                        ...
                        <li>
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(auth()->user()->role === 'patient'): ?>
                                    <a href="<?php echo e(route('patient.shop.index')); ?>">Mua Thuốc Online</a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('login')); ?>">Mua Thuốc Online</a>
                                <?php endif; ?>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>">Mua Thuốc Online</a>
                            <?php endif; ?>
                        ...
                        <li>
                            <?php if(auth()->guard()->check()): ?>
                                <?php if(auth()->user()->role === 'patient'): ?>
                                    <a href="<?php echo e(route('patient.chat.index')); ?>">Tư Vấn Online</a>
                                <?php else: ?>
                                    <a href="<?php echo e(route('login')); ?>">Tư Vấn Online</a>
                                <?php endif; ?>
                            <?php else: ?>
                                <a href="<?php echo e(route('login')); ?>">Tư Vấn Online</a>
                            <?php endif; ?>
            ...
            <div class="vc-footer-bottom mt-4 text-center">
                &copy; <?php echo e(date('Y')); ?> VietCare. All rights reserved.
            </div>
    ...
    <script>
        ...
        function openDoctorSchedule(doctorId) {
            const url = "<?php echo e(url('/bac-si')); ?>/" + doctorId + "/lich-ranh";
...
<?php /**PATH F:\WORKING\DACN\DACN\resources\views/home.blade.php ENDPATH**/ ?>