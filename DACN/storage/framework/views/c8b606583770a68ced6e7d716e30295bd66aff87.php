...
<?php $__env->startSection('title', 'Thêm lịch khám thai'); ?>
...
<div class="container-fluid py-4">
        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="<?php echo e(route('doctor.theo-doi-thai-ky.show', $theoDoiThaiKy->id)); ?>">Hồ sơ #<?php echo e($theoDoiThaiKy->id); ?></a></li>
    ...
    <form action="<?php echo e(route('doctor.lich-kham-thai.store', $theoDoiThaiKy->id)); ?>" method="POST">
        <?php echo csrf_field(); ?>
                ...
                <div class="card vc-card mb-4">
                    ...
                    <div class="card-body">
                        <div class="alert alert-info mb-0">
                            <div class="row">
                                <div class="col-md-6">
                                    <p class="mb-1"><strong>Họ tên:</strong> <?php echo e($theoDoiThaiKy->user->name); ?></p>
                                    <p class="mb-1"><strong>Email:</strong> <?php echo e($theoDoiThaiKy->user->email); ?></p>
                                    <?php if($theoDoiThaiKy->user->so_dien_thoai): ?>
                                    <p class="mb-0"><strong>SĐT:</strong> <?php echo e($theoDoiThaiKy->user->so_dien_thoai); ?></p>
                                    <?php endif; ?>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-1"><strong>Ngày kinh cuối:</strong> <?php echo e(\Carbon\Carbon::parse($theoDoiThaiKy->ngay_kinh_cuoi)->format('d/m/Y')); ?></p>
                                    <p class="mb-1"><strong>Ngày dự sinh:</strong> <?php echo e(\Carbon\Carbon::parse($theoDoiThaiKy->ngay_du_sinh)->format('d/m/Y')); ?></p>
                                    <p class="mb-0"><strong>Tuổi thai hiện tại:</strong> <span class="badge bg-info"><?php echo e($tuoiThai['tuan']); ?> tuần <?php echo e($tuoiThai['ngay']); ?> ngày</span></p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="date" name="ngay_kham" class="form-control" 
                                       value="<?php echo e(old('ngay_kham', now()->format('Y-m-d'))); ?>" required>
                                <?php $__errorArgs = ['ngay_kham'];
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="tuan_thai" class="form-control" 
                                       value="<?php echo e(old('tuan_thai', $tuoiThai['tuan'])); ?>" required min="0" max="42">
                                <?php $__errorArgs = ['tuan_thai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="ngay_thai" class="form-control" 
                                       value="<?php echo e(old('ngay_thai', $tuoiThai['ngay'])); ?>" min="0" max="6">
                                <?php $__errorArgs = ['ngay_thai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="0.1" name="can_nang" class="form-control" 
                                       value="<?php echo e(old('can_nang')); ?>" placeholder="VD: 58.5">
                                <?php $__errorArgs = ['can_nang'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="1" name="huyet_ap_tam_thu" class="form-control" 
                                       value="<?php echo e(old('huyet_ap_tam_thu')); ?>" placeholder="VD: 120">
                                <?php $__errorArgs = ['huyet_ap_tam_thu'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="1" name="huyet_ap_tam_truong" class="form-control" 
                                       value="<?php echo e(old('huyet_ap_tam_truong')); ?>" placeholder="VD: 80">
                                <?php $__errorArgs = ['huyet_ap_tam_truong'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3 mb-3">
                                ...
                                <input type="number" step="0.1" name="nhiet_do" class="form-control" 
                                       value="<?php echo e(old('nhiet_do')); ?>" placeholder="VD: 36.5">
                                <?php $__errorArgs = ['nhiet_do'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" name="nhip_tim_me" class="form-control" 
                                       value="<?php echo e(old('nhip_tim_me')); ?>" placeholder="VD: 80">
                                <?php $__errorArgs = ['nhip_tim_me'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="0.1" name="chieu_cao_tu_cung" class="form-control" 
                                       value="<?php echo e(old('chieu_cao_tu_cung')); ?>" placeholder="VD: 28">
                                <?php $__errorArgs = ['chieu_cao_tu_cung'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="number" step="0.1" name="vong_bung" class="form-control" 
                                       value="<?php echo e(old('vong_bung')); ?>" placeholder="VD: 95">
                                <?php $__errorArgs = ['vong_bung'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="nhip_tim_thai" class="form-control" 
                                       value="<?php echo e(old('nhip_tim_thai')); ?>" placeholder="VD: 145">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="vi_tri_thai" class="form-select">
                                    ...
                                    <option value="Ngôi đầu" <?php echo e(old('vi_tri_thai') === 'Ngôi đầu' ? 'selected' : ''); ?>>Ngôi đầu</option>
                                    <option value="Ngôi mông" <?php echo e(old('vi_tri_thai') === 'Ngôi mông' ? 'selected' : ''); ?>>Ngôi mông</option>
                                    <option value="Ngôi ngang" <?php echo e(old('vi_tri_thai') === 'Ngôi ngang' ? 'selected' : ''); ?>>Ngôi ngang</option>
                                    <option value="Chưa xác định" <?php echo e(old('vi_tri_thai') === 'Chưa xác định' ? 'selected' : ''); ?>>Chưa xác định</option>
                                </select>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea name="trieu_chung" class="form-control" rows="3"
                                      placeholder="Ghi nhận các triệu chứng bất thường: đau bụng, chảy máu, phù chân..."><?php echo e(old('trieu_chung')); ?></textarea>
                            <?php $__errorArgs = ['trieu_chung'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="kham_lam_sang" class="form-control" rows="3"
                                      placeholder="Mô tả chi tiết kết quả khám: tim phổi, bụng, tử cung..."><?php echo e(old('kham_lam_sang')); ?></textarea>
                            <?php $__errorArgs = ['kham_lam_sang'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="chi_dinh" class="form-control" rows="2"
                                      placeholder="Các chỉ định xét nghiệm, siêu âm cần làm..."><?php echo e(old('chi_dinh')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="danh_gia" class="form-control" rows="3"
                                      placeholder="Đánh giá tình trạng thai kỳ: bình thường, có nguy cơ..."><?php echo e(old('danh_gia')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="tu_van" class="form-control" rows="3"
                                      placeholder="Tư vấn dinh dưỡng, chế độ sinh hoạt, lưu ý..."><?php echo e(old('tu_van')); ?></textarea>
                            <?php $__errorArgs = ['tu_van'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="date" name="hen_kham_lai" class="form-control" 
                                       value="<?php echo e(old('hen_kham_lai')); ?>">
                                <?php $__errorArgs = ['hen_kham_lai'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
            ...
            <div class="col-lg-4">
                ...
                <div class="card vc-card">
                    ...
                    <div class="card-body">
                        ...
                        ?>
                        <p class="mb-2"><strong>Ngày:</strong> <?php echo e(\Carbon\Carbon::parse($lastExam->ngay_kham)->format('d/m/Y')); ?></p>
                        <p class="mb-2"><strong>Tuần thai:</strong> <?php echo e($lastExam->tuan_thai); ?> tuần <?php echo e($lastExam->ngay_thai); ?> ngày</p>
                        <?php if($lastExam->can_nang): ?>
                        <p class="mb-2"><strong>Cân nặng:</strong> <?php echo e($lastExam->can_nang); ?> kg</p>
                        <?php endif; ?>
                        <?php if($lastExam->nhip_tim_thai): ?>
                        <p class="mb-2"><strong>Tim thai:</strong> <?php echo e($lastExam->nhip_tim_thai); ?> bpm</p>
                        <?php endif; ?>
                        <?php if($lastExam->hen_kham_lai): ?>
                        <div class="alert alert-info mb-0 mt-2 py-2">
                            <small><strong>Đã hẹn:</strong> <?php echo e(\Carbon\Carbon::parse($lastExam->hen_kham_lai)->format('d/m/Y')); ?></small>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.doctor', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\WORKING\DACN\DACN\resources\views/doctor/lich-kham-thai/create.blade.php ENDPATH**/ ?>