...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid px-4 py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create', App\Models\BenhAn::class)): ?>
                <a href="<?php echo e(route(auth()->user()->role . '.benhan.create')); ?>" class="btn btn-success px-4 py-2 shadow-sm">
            ...
            <div class="card-body p-4">
                <form method="GET" class="row g-3">
                    <div class="col-lg-2 col-md-4">
                        ...
                        <input class="form-control" type="text" name="ma" value="<?php echo e(request('ma')); ?>"
                    ...
                    <div class="col-lg-3 col-md-4">
                        ...
                        <input class="form-control" type="text" name="q" value="<?php echo e(request('q')); ?>"
                    ...
                    <div class="col-lg-3 col-md-4">
                        ...
                        <input class="form-control" type="date" name="from" value="<?php echo e(request('from')); ?>">
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <input class="form-control" type="date" name="to" value="<?php echo e(request('to')); ?>">
                    </div>
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $records; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="border-bottom">
                                <td class="py-3 ps-4">
                                    <span class="badge bg-secondary">HS-<?php echo e(str_pad($r->id, 4, '0', STR_PAD_LEFT)); ?></span>
                                </td>
                                <td class="py-3">
                                    <span class="fw-semibold"><?php echo e($r->ngay_kham->format('d/m/Y')); ?></span>
                                </td>
                                <td class="py-3">
                                    <div class="fw-semibold"><?php echo e($r->tieu_de); ?></div>
                                </td>
                                <td class="py-3">
                                    <?php echo e($r->benhNhan->name ?? 'N/A'); ?>

                                </td>
                                <td class="py-3">
                                    <?php echo e($r->bacSi->ho_ten ?? 'N/A'); ?>
                                ...
                                <td class="text-center py-3 pe-4">
                                    <div class="btn-group" role="group">
                                        ...
                                        <a href="<?php echo e(route(auth()->user()->role . '.benhan.show', $r)); ?>"
                                            class="btn btn-sm btn-outline-primary" title="Xem chi tiết">
                                            <i class="fas fa-eye"></i>
                                        </a>

                                        
                                        <?php if(in_array(auth()->user()->role, ['admin', 'doctor'])): ?>
                                            <a href="<?php echo e(route(auth()->user()->role . '.benhan.edit', $r)); ?>"
...
<?php echo $__env->make($layout, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\WORKING\DACN\DACN\resources\views/benh_an/index.blade.php ENDPATH**/ ?>