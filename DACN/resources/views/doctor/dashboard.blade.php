...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="fw-bold mb-1">Chào mừng, BS. {{ $bacSi->ho_ten }} 👋</h2>
                ...
                <div class="text-end">
                    ...
                    <p class="mb-0 fw-bold fs-5">{{ now()->format('H:i') }}</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0">{{ $avgRating }} <span class="fs-6 text-warning">★</span></h3>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-start">
                        <div>
                            ...
                            <h3 class="fw-bold mb-0">{{ $appointmentsThisMonth }}</h3>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 pt-3">
                    <h5 class="fw-bold mb-0">📊 Lịch hẹn 7 ngày qua</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm h-100">
                <div class="card-header bg-white border-0 pt-3">
                    <h5 class="fw-bold mb-0">📈 Trạng thái tháng này</h5>
                </div>
                <div class="card-body">
        ...
        <div class="col-12">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 pt-3 d-flex justify-content-between align-items-center">
                    <h5 class="fw-bold mb-0">🗓️ Lịch hẹn hôm nay ({{ $todayAppointments->count() }})</h5>
                    <a href="{{ route('doctor.calendar.index') }}" class="btn btn-sm btn-outline-primary">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <strong>{{ \Carbon\Carbon::parse($appt->thoi_gian_hen)->format('H:i') }}</strong>
                                        </td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar-circle bg-primary text-white me-2" style="width: 36px; height: 36px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">
                                        ...
                                        <td>{{ $appt->dichVu->ten_dich_vu ?? 'N/A' }}</td>
                                        <td>
                                            @php
                                                $badgeClass = match($appt->trang_thai) {
                                            ...
                                            @endphp
                                            <span class="badge {{ $badgeClass }}">{{ $appt->trang_thai }}</span>
                                        </td>
                                        <td>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 pt-3">
                    <h5 class="fw-bold mb-0">📅 Lịch hẹn sắp tới (7 ngày)</h5>
                </div>
                                ...
                                <div class="d-flex justify-content-between align-items-start">
                                    <div class="flex-grow-1">
                                        <div class="d-flex align-items-center mb-2">
                                            <div class="avatar-circle bg-info text-white me-2" style="width: 32px; height: 32px; border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 14px;">
                                        ...
                                        <small class="text-muted">{{ $upcoming->dichVu->ten_dich_vu ?? 'N/A' }}</small>
                                    </div>
                                    <div>
                                        @php
                                            $badgeClass = match($upcoming->trang_thai) {
                                                'Đã xác nhận' => 'bg-success',
                                                'Chờ xác nhận' => 'bg-warning',
                                                default => 'bg-secondary'
                                            };
                                        @endphp
                                        <span class="badge {{ $badgeClass }}">{{ $upcoming->trang_thai }}</span>
                                    </div>
                                </div>
                            </div>
                            @endforeach
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white border-0 pt-3">
                    <h5 class="fw-bold mb-0">⭐ Đánh giá gần đây</h5>
                </div>
                <div class="card-body" style="max-height: 400px; overflow-y: auto;">
