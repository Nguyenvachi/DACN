                ...
                if (window.jQuery && $.fn.DataTable && !$.fn.DataTable.isDataTable('#appointmentsTable')) {
                    const dt = $('#appointmentsTable').DataTable({
                        ...
                        columnDefs: [
                            ...
                            { targets: 2, width: '140px', className: 'text-nowrap' },
                            { targets: 3, width: '240px' },
                            { targets: 4, width: '140px', className: 'text-nowrap' },
                            { targets: 5, width: '130px', className: 'text-nowrap' },
                            { targets: 6, width: '170px', className: 'text-nowrap', orderable: false }
                        ]
                    });
