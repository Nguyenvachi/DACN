                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            @if($hoaDon->con_lai > 0)
                                                <a href="{{ route('patient.payment', $hoaDon->lichHen) }}" class="btn btn-outline-success" title="Thanh toán">
                                                    <i class="fas fa-credit-card"></i>
                                                </a>
                                            @endif
                                            @if($hoaDon->trang_thai === 'da_thanh_toan')
                                                <a href="{{ route('admin.hoadon.receipt', $hoaDon) }}" target="_blank" class="btn btn-outline-info" title="Tải hóa đơn">
