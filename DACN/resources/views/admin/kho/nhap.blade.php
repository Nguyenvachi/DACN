...
@json($drugOptions)
    ...
    @push('scripts')
        <script>
            let drugs = JSON.parse(document.getElementById('drugs-data').textContent);
            let currentDrugs = drugs; // Danh sách thuốc hiện tại
                ...
                try {
                    ...
                    if (result.success) {
                        ...
                        if (currentDrugs.length === 0) {
                            ...
                            // Thêm 1 dòng mới với danh sách thuốc đã lọc
                            i = 0;
            ...
            tbody.addEventListener('change', e => {
                if (e.target.classList.contains('drug-select')) {
                    ...
                    if (drug && drug.gia_nhap_mac_dinh) {
                        ...
                        priceInput.value = drug.gia_nhap_mac_dinh;
                    }
                }
            });
