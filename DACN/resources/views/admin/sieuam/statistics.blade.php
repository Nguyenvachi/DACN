...
@section('title', 'Thống kê Siêu âm')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1 fw-bold text-dark">
                ...
                Thống kê & Báo cáo Siêu âm
            </h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.sieuam.index') }}">Siêu âm</a></li>
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-0">Siêu âm đã hoàn thành</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mt-2">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="sieuAmTopDoctorsTable" class="table table-sm table-hover">
                            <thead>
                                <tr>
                                    <th>STT</th>
                                    <th>Bác sĩ</th>
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 fw-bold">
                        <i class="fas fa-wave-square text-success me-2"></i>Top 10 Loại siêu âm phổ biến
                    </h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="sieuAmTopTypesTable" class="table table-sm table-hover">
                            <thead>
                                <tr>
                                    <th>STT</th>
                                    <th>Loại siêu âm</th>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // DataTables: Top loại siêu âm
    if (window.jQuery && $.fn.DataTable && !$.fn.DataTable.isDataTable('#sieuAmTopTypesTable')) {
        $('#sieuAmTopTypesTable').DataTable({
            paging: false,
            info: false,
            searching: false,
            lengthChange: false,
