    ...
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <div class="text-muted">Quản trị danh sách bản ghi theo dõi</div>
            </div>
        </div>
            ...
            <div class="card-body">
                <form method="GET" class="row g-3">
                    <div class="col-md-5">
                        ...
                        <input type="text" name="search" class="form-control" value="{{ request('search') }}" placeholder="ID, bệnh nhân, bác sĩ...">
                    </div>
                    <div class="col-md-4">
                        ...
                        <tbody>
                            @forelse($records as $r)
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a class="btn btn-sm btn-outline-primary" href="{{ route('admin.theodoithaiky.show', $r) }}">Xem</a>
                                    </td>
                                </tr>
                            @empty
