                ...
                <form method="POST" action="{{ route('admin.roles.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}"
                            class="form-control form-control-lg" placeholder="Ví dụ: manager, staff, doctor" required>
                        ...
                        <div class="border rounded p-3" style="max-height: 340px; overflow-y: auto;">
                            ...
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-2">
                                ...
                                @empty
                                    <p class="text-muted">
                                        Chưa có quyền nào.
                                        <a href="{{ route('admin.permissions.create') }}" class="text-primary">
                                            Tạo quyền mới
                                        </a>
                                    </p>
                                @endforelse
                    ...
                    <div class="mt-4 d-flex justify-content-end">
                        ...
                        <button class="btn btn-primary px-4">
                            <i class="fas fa-save me-1"></i> Tạo vai trò
                        </button>
                    </div>
