...
<div class="container-fluid py-4">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('admin.xquang.statistics') }}" class="btn btn-outline-primary">
                <i class="fas fa-chart-bar me-2"></i>Thống kê
            </a>
            <a href="{{ route('admin.xquang.export') }}" class="btn btn-success">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="GET" action="{{ route('admin.xquang.index') }}">
                <div class="row g-3">
                    <div class="col-md-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">{{ $xq->benhAn->user->email ?? '' }}</small>
                                    </div>
                                </div>
                            </td>
                            <td>{{ $xq->bacSi->user->name ?? 'N/A' }}</td>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.xquang.show', $xq) }}" class="btn btn-sm btn-outline-primary" title="Xem chi tiết">
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-4">
                                ...
                                <p class="text-muted">Không có dữ liệu X-Quang</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
