...
@section('title', 'Thống kê Xét nghiệm')
        ...
        <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body text-center">
                    ...
                    <p class="text-muted mb-0">Xét nghiệm đã hoàn thành</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row g-4 mt-2">
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="xetNghiemTopDoctorsTable" class="table table-sm table-hover">
                            <thead>
                                <tr>
                                    <th>STT</th>
                                    <th>Bác sĩ</th>
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm">
                <div class="card-header bg-white py-3">
                    <h5 class="mb-0 fw-bold">
                        <i class="fas fa-flask text-success me-2"></i>Top 10 Loại xét nghiệm phổ biến
                    </h5>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table id="xetNghiemTopTypesTable" class="table table-sm table-hover">
                            <thead>
                                <tr>
                                    <th>STT</th>
...
<x-datatable-script
    tableId="xetNghiemTopDoctorsTable"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // DataTables: Top loại xét nghiệm
    if (window.jQuery && $.fn.DataTable && !$.fn.DataTable.isDataTable('#xetNghiemTopTypesTable')) {
        $('#xetNghiemTopTypesTable').DataTable({
            paging: false,
            info: false,
            searching: false,
            lengthChange: false,
