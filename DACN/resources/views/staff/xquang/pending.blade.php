...
@section('title', 'X-Quang chờ thực hiện')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="mb-1 fw-bold text-dark">
                ...
                X-Quang chờ thực hiện
            </h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('staff.dashboard') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active">X-Quang chờ</li>
                </ol>
            </nav>
        </div>
        <div>
            <a href="{{ route('staff.xquang.completed') }}" class="btn btn-outline-success">
                ...
                <table class="table table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><small>{{ $xq->created_at->format('d/m/Y H:i') }}</small></td>
                            <td>
                            ...
                            <td class="text-center">
                                @if($xq->trang_thai === 'pending')
                                    <form action="{{ route('staff.xquang.processing', $xq) }}" method="POST" class="d-inline">
                                        @csrf
                                ...
                                @endif
                                <a href="{{ route('staff.xquang.upload.form', $xq) }}" class="btn btn-sm btn-primary" title="Upload kết quả">
                                    <i class="fas fa-upload"></i>
                                </a>
                                <a href="{{ route('staff.xquang.show', $xq) }}" class="btn btn-sm btn-outline-secondary" title="Xem chi tiết">
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                ...
                                <h5 class="text-muted">Không có X-Quang chờ thực hiện</h5>
                                <p class="text-muted mb-0">Tất cả X-Quang đã được xử lý</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
