...
<div class="container-fluid py-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            ...
            <div class="text-muted">Danh sách yêu cầu tái khám</div>
        </div>
    </div>
    ...
    <div class="row g-3 mb-3">
        ...
        <div class="col-md-3"><div class="card"><div class="card-body"><div class="text-muted small">Hoàn thành</div><div class="fs-4 fw-bold">{{ $stats['completed'] ?? 0 }}</div></div></div></div>
        <div class="col-md-3"><div class="card"><div class="card-body"><div class="text-muted small">Đã hủy</div><div class="fs-4 fw-bold">{{ $stats['cancelled'] ?? 0 }}</div></div></div></div>
    </div>
                    ...
                    <tbody>
                        @forelse($records as $r)
                            <tr>
                                ...
                                <td class="text-end">
                                    <a class="btn btn-sm btn-outline-primary" href="{{ route('staff.taikham.show', $r) }}">Xem</a>
                                </td>
                            </tr>
                        @empty
